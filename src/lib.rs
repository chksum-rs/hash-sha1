//! This crate provides an implementation of the SHA-1 hash function based on [RFC 3174: US Secure Hash Algorithm 1 (SHA1)](https://tools.ietf.org/html/rfc3174).
//!
//! # Setup
//!
...
//! assert_eq!(
//!     digest.to_hex_lowercase(),
//!     "78673b8775fc5366cb839271b89412de5a447687"
//! );
//! ```
//!
//! # Disclaimer
...
/// use chksum_hash_sha1 as sha1;
///
/// let digest = sha1::default().digest();
/// assert_eq!(
///     digest.to_hex_lowercase(),
///     "da39a3ee5e6b4b0d3255bfef95601890afd80709"
/// );
...
impl Finalize {
    ...
    #[rustfmt::skip]
    pub fn digest(&self) -> Digest {
        let State { a, b, c, d, e } = self.state;
        let [a, b, c, d, e] = [
            a.to_be_bytes(),
            b.to_be_bytes(),
            c.to_be_bytes(),
